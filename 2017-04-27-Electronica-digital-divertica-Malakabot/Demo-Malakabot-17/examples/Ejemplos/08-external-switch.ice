  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "0d9b886f-2d1e-4895-8f4c-38fbb4c9b858",
          "type": "basic.input",
          "data": {
            "name": "Switch",
            "pins": [
        ...
        {
          "id": "9c4ba00f-dde2-44b3-92a0-5ced753aa2bd",
          "type": "basic.output",
          "data": {
            "name": "LEDEXT",
            "pins": [
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "0d9b886f-2d1e-4895-8f4c-38fbb4c9b858",
            "port": "out"
          },
          "target": {
            "block": "9c4ba00f-dde2-44b3-92a0-5ced753aa2bd",
            "port": "in"
          },
          "vertices": []
        }
