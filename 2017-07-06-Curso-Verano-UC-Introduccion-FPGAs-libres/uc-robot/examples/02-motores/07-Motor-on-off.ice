    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Controlador del motor: Motorbit\n\nTiene dos bits de entrada:\n\n* on: Si está a 1, el motor está\n encendido, girando. Cuando es 0, \n el motor está parado\n \n* dir: Direccion de giro del motor. \nCuando el motor está encendido, este\nbit determina el sentido de giro\n(horario / antihorario)",
            "readonly": true
          },
          "position": {
            "x": 496,
        ...
        {
          "id": "ba7b7853-1ee4-4b28-96ba-6176be4aecca",
          "type": "basic.info",
          "data": {
            "info": "Probando un motor:\n\nCon el pulsador SW1 hacemos que el motor esté girando o parado. Por un\nled sacamos el estado del motor (encendido/apagado)\n\nNOTA: Cuando está apagado, el motor debería estar parado. Sin embargo,\nes muy probable que se mueva despacio: esto es porque hay que \ncalibrarlo (se hará en el siguiente ejemplo)\n",
            "readonly": true
          },
          "position": {
            "x": 152,
