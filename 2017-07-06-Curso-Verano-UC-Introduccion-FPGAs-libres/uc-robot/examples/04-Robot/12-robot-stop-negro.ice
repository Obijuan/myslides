    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Movimiento autónomo del robot: parar con el negro\n\nSe usa uno de los sensores para detectar blanco/negro. Cuando lee blanco el\nrobot avanza en línea recta, hasta que detecte negro, parándose\n\nAl llegar al borde de la mesa se parará (ya que el infinito es detectado como negro)",
            "readonly": true
          },
          "position": {
            "x": 64,
        ...
        {
          "id": "a87c4afb-3e91-453a-b9e1-9f0776b4166a",
          "type": "7f3e9f0a05c929c3761852e259027fbe8e977795",
          "position": {
            "x": 248,
            "y": -184
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a87c4afb-3e91-453a-b9e1-9f0776b4166a",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
