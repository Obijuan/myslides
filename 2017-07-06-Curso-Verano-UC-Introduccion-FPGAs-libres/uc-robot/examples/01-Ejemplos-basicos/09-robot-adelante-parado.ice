    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Movimiento del robot hacia adelante / parado, determinado por el pulsador SW1\n\nSi el robot se moviese hacia atrás, en vez de hacia adelante, cambiar la constante 0 por un 1\n\nSi cuando el robot debiera estar parado (led0 apagado) se mueve, hay que recalibrar los motores\n(cambiando los valores de la constante ST de sus motores)",
            "readonly": true
          },
          "position": {
            "x": 80,
